...
const i18n = {
  ...
  es: {
    ...
    refresh: "Actualizar",
    runDiagnostic: "Ejecutar diagnÃ³stico",
    ready: "Listo",
    status: "Estado",
    ...
    diagnosticDesc: "Comprobaciones automÃ¡ticas",
    ping: "Ping",
    ...
    fullDiagnostic: "DiagnÃ³stico completo",
    ...
    reportActionDesc: "Copiar resumen de diagnÃ³stico",
    emptyDashboard: "Pulsa Actualizar o Ejecutar diagnÃ³stico para cargar el resumen de red.",

    automaticDiagnostic: "DiagnÃ³stico automÃ¡tico",
    automaticDiagnosticHelp: "Comprueba gateway, DNS, IP de internet y resoluciÃ³n de dominio.",
    recommendations: "Recomendaciones",
    emptyDiagnostic: "Ejecuta el diagnÃ³stico para generar comprobaciones y recomendaciones.",

    hostOrIp: "Host o IP",
    pingHelp: "Comprueba si un host o IP responde. Ãštil para probar gateway, DNS, IPs pÃºblicas o dominios.",
    noPing: "TodavÃ­a no hay resultado de ping.",
    ...
    noPortResult: "TodavÃ­a no hay resultado de prueba de puerto.",
    localPorts: "Puertos locales en escucha",
    localPortsHelp: "Muestra los puertos TCP que estÃ¡n escuchando en este PC.",
    ...
    networkScanTitle: "Network Scan",
    networkScanHelp: "Descubrimiento inteligente de LAN local. Comprueba hosts activos, entradas ARP conocidas, direcciÃ³n broadcast y puertos comunes en modo seguro V1.",
    startScan: "Iniciar escaneo",
    scanning: "Escaneando...",
    scanNote: "Este mÃ³dulo estÃ¡ pensado solo para tu propia red o redes donde tengas permiso. La V1 evita rangos pÃºblicos y solo comprueba un conjunto pequeÃ±o de puertos comunes en hosts locales descubiertos.",
    scanReady: "TodavÃ­a no se ha ejecutado ningÃºn escaneo de red.",
    ...
    tracerouteHelp: "Traza la ruta desde este PC hasta un host o IP. Ãštil para detectar problemas de rutas, ISP o red.",
    runTraceroute: "Ejecutar traceroute",
    tracing: "Trazando...",
    traceRunning: "Ejecutando traceroute...",
    traceNote: "Traceroute es manual porque puede tardar varios segundos. La V1 usa un lÃ­mite optimizado de 12 saltos y 600 ms por salto.",
    noTrace: "TodavÃ­a no hay resultado de traceroute.",

    activeAdapters: "Adaptadores activos",
    activeAdaptersHelp: "Muestra adaptadores activos con IP, gateway, DNS y direcciÃ³n MAC.",
    noAdapters: "No hay adaptadores activos cargados. Pulsa Actualizar primero.",
    ips: "IPs",

    diagnosticReport: "Informe de diagnÃ³stico",
    diagnosticReportHelp: "Copia o exporta el resumen de red y el resultado del diagnÃ³stico.",
    copyReport: "Copiar informe",
    exportTxt: "Exportar TXT",
    reportCopied: "Informe copiado al portapapeles.",
    noReport: "Ejecuta el diagnÃ³stico para generar un informe.",
    noExportData: "Ejecuta un diagnÃ³stico o actualiza el resumen antes de exportar.",
    txtExported: "TXT exportado:",
    copyFailed: "No se pudo copiar automÃ¡ticamente. Selecciona el texto del informe manualmente."
  },
  pt: {
    appTitle: "Ferramentas de Rede",
    brand: "MPTech Tools",
    subtitle: "Kit portÃ¡til para Windows",
    refresh: "Atualizar",
    runDiagnostic: "Executar diagnÃ³stico",
    ready: "Pronto",
    status: "Estado",
    notLoaded: "NÃ£o carregado",
    ...
    diagnostic: "DiagnÃ³stico",
    diagnosticDesc: "VerificaÃ§Ãµes automÃ¡ticas",
    ping: "Ping",
    ...
    traceroute: "Traceroute",
    tracerouteDesc: "Rota atÃ© um host",
    adapters: "Adaptadores",
    ...
    tracerouteActionDesc: "Mostrar rota atÃ© um host",
    reportActionDesc: "Copiar resumo do diagnÃ³stico",
    emptyDashboard: "Clique em Atualizar ou Executar diagnÃ³stico para carregar o resumo da rede.",

    automaticDiagnostic: "DiagnÃ³stico automÃ¡tico",
    automaticDiagnosticHelp: "Verifica gateway, DNS, IP de internet e resoluÃ§Ã£o de domÃ­nio.",
    recommendations: "RecomendaÃ§Ãµes",
    emptyDiagnostic: "Execute o diagnÃ³stico para gerar verificaÃ§Ãµes e recomendaÃ§Ãµes.",

    hostOrIp: "Host ou IP",
    pingHelp: "Verifica se um host ou IP responde. Ãštil para testar gateway, DNS, IPs pÃºblicas ou domÃ­nios.",
    noPing: "Ainda nÃ£o hÃ¡ resultado de ping.",

    tcpPortTest: "Teste de porta TCP",
    tcpPortHelp: "Verifica se um serviÃ§o TCP estÃ¡ acessÃ­vel. Exemplo: google.com:443, router:80, servidor:22.",
    port: "Porta",
    testPort: "Testar porta",
    noPortResult: "Ainda nÃ£o hÃ¡ resultado de teste de porta.",
    localPorts: "Portas locais em escuta",
    localPortsHelp: "Mostra as portas TCP que estÃ£o em escuta neste PC.",
    ...
    networkScanTitle: "Network Scan",
    networkScanHelp: "Descoberta inteligente da LAN local. Verifica hosts ativos, entradas ARP conhecidas, endereÃ§o broadcast e portas comuns em modo seguro V1.",
    startScan: "Iniciar varredura",
    scanning: "Escaneando...",
    scanNote: "Este mÃ³dulo deve ser usado apenas na sua prÃ³pria rede ou em redes onde vocÃª tem permissÃ£o. A V1 evita faixas pÃºblicas e verifica apenas um pequeno conjunto de portas comuns em hosts locais descobertos.",
    scanReady: "Ainda nÃ£o foi executada nenhuma varredura de rede.",
    scanRunning: "Escaneando a rede local em modo seguro V1. Pode levar alguns segundos...",
    scanDone: "Varredura concluÃ­da. Entradas encontradas:",
    noScanRows: "Execute uma varredura para listar dispositivos ativos na sua rede local.",
    copyScanReport: "Copiar relatÃ³rio",
    exportScanTxt: "Exportar TXT",
    runScanFirst: "Execute o Network Scan primeiro.",
    scanReportCopied: "RelatÃ³rio do Network Scan copiado para a Ã¡rea de transferÃªncia.",
    ...
    tracerouteHelp: "TraÃ§a a rota deste PC atÃ© um host ou IP. Ãštil para detectar problemas de rota, ISP ou rede.",
    runTraceroute: "Executar traceroute",
    tracing: "TraÃ§ando...",
    traceRunning: "Executando traceroute...",
    traceNote: "Traceroute Ã© manual porque pode levar vÃ¡rios segundos. A V1 usa um limite otimizado de 12 saltos e 600 ms por salto.",
    noTrace: "Ainda nÃ£o hÃ¡ resultado de traceroute.",

    activeAdapters: "Adaptadores ativos",
    activeAdaptersHelp: "Mostra adaptadores ativos com IP, gateway, DNS e endereÃ§o MAC.",
    noAdapters: "Nenhum adaptador ativo carregado. Clique em Atualizar primeiro.",
    ips: "IPs",

    diagnosticReport: "RelatÃ³rio de diagnÃ³stico",
    diagnosticReportHelp: "Copie ou exporte o resumo da rede e o resultado do diagnÃ³stico.",
    copyReport: "Copiar relatÃ³rio",
    exportTxt: "Exportar TXT",
    reportCopied: "RelatÃ³rio copiado para a Ã¡rea de transferÃªncia.",
    noReport: "Execute o diagnÃ³stico para gerar um relatÃ³rio.",
    noExportData: "Execute um diagnÃ³stico ou atualize o resumo antes de exportar.",
    txtExported: "TXT exportado:",
    copyFailed: "NÃ£o foi possÃ­vel copiar automaticamente. Selecione o texto do relatÃ³rio manualmente."
  }
} as const;
